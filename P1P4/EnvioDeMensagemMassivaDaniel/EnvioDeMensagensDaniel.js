function sheets(){
  const fs = require('fs').promises;
    ...
    const res = await sheets.spreadsheets.values.get({
        spreadsheetId: '1qtcboFynyfKWBIFibJqAoB6xApF_hK-q9CLJdT6dZ4Y',
...
sheets().then((valores) => {
  ...
  if (valores == '') {
      ...
      valores.push([['11945274604'], [`P1P4 🤖🪁 responsável pela *Envio de Mensagem Massivo Agendadas Daniel* funcionando! ${getCurrentDateTimeBrazilian()} \n`]])
      whats(valores)
