...
sheets().then((valores) => {
    ...
    if (valores == '') {
        ...
        valores.push([['11985848901'], [`Teste Envio de Mensagens Responsaveis Peripecias  ${getCurrentDateTimeBrazilian()} \n`]])
        valores.push([['11945274604'], [`Teste Envio de Mensagens Responsaveis Peripecias  ${getCurrentDateTimeBrazilian()} \n`]])
        whats(valores)
